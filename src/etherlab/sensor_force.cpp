...
#define WMLAN9252_IO 0x00000002, 0x15232452


// offsets for PDO entries
static unsigned int off_analog_data1;
static unsigned int off_analog_data2;

struct wmlan9252_io_data_struct
{
  uint32_t analog_data;
};
static struct wmlan9252_io_data_struct wmlan9252_io_data;

const static ec_pdo_entry_reg_t domain1_regs[] =
{
    {WMLAN9252_IO_POS,  WMLAN9252_IO, 0x3101, 0x01, &off_analog_data1, NULL},
//    {WMLAN9252_IO_POS,  WMLAN9252_IO, 0x3101, 0x01, &off_analog_data2, NULL},
    {}
};
...
//    {0x1A01, 1, wmlan9252_io_txpdo_entries}, /* TxPdo Channel 1 */
};

ec_sync_info_t wmlan9252_io_syncs[] = {
//    {2, EC_DIR_OUTPUT, 1, wmlan9252_io_rxpdos, EC_WD_ENABLE},
    {3, EC_DIR_INPUT, 1, wmlan9252_io_txpdos, EC_WD_ENABLE},
    {0xff}
};
...
//    if ((++counter_check) >= FREQUENCY) // do this at 1 Hz
    ...
    if((++counter_txrx) >= 200)
	{
		...
		#if 1
		    // read process data
            wmlan9252_io_data.analog_data = EC_READ_S32(domain1_pd + off_analog_data1);
		#endif
         printf("receive ADC value: %d \n\n",wmlan9252_io_data.analog_data);
	}
	// send process data
